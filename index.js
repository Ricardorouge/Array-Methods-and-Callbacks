...
function getFinals(array) {
   const newArr = array.filter(item => item.Stage === 'Final');
   return newArr;
}
console.log('Test2',getFinals(fifaData));
...
function getAverageGoals(array,getFinalscb) {
   const averageGoals = array.reduce((acc,item)=> acc + item['Home Team Goals'] + item['Away Team Goals'],0);
